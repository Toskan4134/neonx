...
module.exports = {
    ...
    cooldown: 5,
    usage: "reloadbot",
    description: "Recarga el bot, todos los eventos, comandos, etc..",
        ...
        try {
            ...
            let tempmsg = await message.channel.send({
                embeds: [new MessageEmbed()
                    ...
                    .setTitle("Recargando ...")
                    .setDescription(`> Recargando **\`${client.commands.size} Comandos\`**\n\n> Recargando **\`${eventcount} Eventos\`**\n\n> Recargando **\`${client.handlers.size} Módulos/Características\`**`)
                ]
            })
            ...
            await tempmsg.edit({
                embeds: [new MessageEmbed()
                    .setTitle("Recargado Exitosamente:")
                    .setDescription(`> **\`${client.commands.size} Comandos\`**\n\n> **\`${eventcount} Eventos\`**\n\n> **\`${client.handlers.size} Módulos/Características\`**`)
                    .setColor(ee.color)
                    .setFooter({ text: ee.footertext, iconURL: ee.footericon })
                    .setThumbnail(ee.footericon)
                ]
