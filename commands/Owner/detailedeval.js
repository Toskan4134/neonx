...
module.exports = {
  ...
  description: `Evalúa un Comando en detalle (sin corte del mensaje resultante)`,
  ...
  run: async (client, message, args, plusArgs, cmdUser, text, prefix) => {
    try {
      ...
      let evalEmbed = new MessageEmbed()
        .setTitle(`${client.user.username} | Detailed Eval`)
        .setColor(ee.color)
        .setDescription("");
      ...
      return message.channel.send(new MessageEmbed()
        ...
        .setTitle(`:x: ERROR | Ha ocurrido un error`)
