...
module.exports = {
  ...
  description: "Muestra la cantidad de comandos y categorías", //the command description for helpcmd [OPTIONAL]
    ...
    try {
      ...
      message.reply({
        embeds: [new MessageEmbed()
          ...
          .setTitle(`:gear: **[${commands(client.commands).length}] Comandos**`)
          .setDescription(`:gear: **[${client.categories.length}] Categorías**`)
        ]
      });
