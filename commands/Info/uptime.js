...
module.exports = {
  ...
  description: "Muestra cuánto tiempo lleva el bot online", //the command description for helpcmd [OPTIONAL]
    ...
    try {
      message.reply({
        embeds: [new MessageEmbed()
          ...
          .setTitle(`:white_check_mark: **${client.user.username}** lleva ${duration(client.uptime)} online`)]
      });
    } catch (e) {
