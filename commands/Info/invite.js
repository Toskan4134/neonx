...
module.exports = {
  ...
  description: "Te envia una invitación del bot", //the command description for helpcmd [OPTIONAL]
  ...
  run: async (client, message, args, plusArgs, cmdUser, text, prefix) => {
    try {
      message.reply(`https://discord.com/api/oauth2/authorize?client_id=932599812879167508&permissions=8&scope=bot%20applications.commands`);
    } catch (e) {
