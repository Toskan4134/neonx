...
const ms = require("ms");
module.exports = {
  name: "reroll", //the command name for the Slash Command
  description: "Vuelve a escoger los ganadores de un sorteo", //the command description for Slash Command Overview
  cooldown: 5,
  ...
  options: [
    ...
    //{"Integer": { name: "ping_amount", description: "How many times do you want to ping?", required: true }}, //to use in the code: interacton.getInteger("ping_amount")
    {
      String: {
        name: "id-sorteo",
        description: "ID del sorteo a rerollear",
        required: true,
      },
    },
      ...
      let res = db.findOne(
        ...
        async (err, docs) => {
            ...
            return interaction.reply({
              embeds: [
                new MessageEmbed()
                  ...
                  .setFooter({ text: ee.footertext, iconURL: ee.footericon })
                  .setTitle(
                    `❌ No se puede hacer reroll de un sorteo que no ha finalizado`
                  ),
              ],
              ephemeral: true,
            });
          ...
          interaction.reply({
            embeds: [
              new MessageEmbed()
                .setTitle("✅ Sorteo rerolleado correctamente")
                .setColor(ee.color)
                .setFooter({ text: ee.footertext, iconURL: ee.footericon }),
            ],
            ephemeral: true,
