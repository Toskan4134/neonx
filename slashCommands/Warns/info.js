...
module.exports = {
    ...
    description: "Da información sobre una Advertencia", //the command description for Slash Command Overview
    cooldown: 1,
    ...
    run: async (client, interaction) => {
        try {
            ...
            channel.send({
                embeds: [
                    new MessageEmbed()
                        .setTitle("ℹ Información de Advertencia")
                        ...
                        .setFooter({ text: ee.footertext, iconURL: ee.footericon })
                        .setTimestamp()
                        .setThumbnail(warned ? warned.user.displayAvatarURL({ dynamic: true }) : ee.footericon)
                ],
            })
        } catch (e) {
