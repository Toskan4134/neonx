...
module.exports = async (client, interaction) => {
    ...
    await guild.channels.create(`『${emoji}』${ID}⇨${customId}`, {
        type: "GUILD_TEXT",
        ...
        const embed = new MessageEmbed()
            ...
            .setFooter({ text: "Los siguientes botones solo los puede usar miembros del STAFF", iconURL: ee.footericon })
            .setColor(ee.color)
        ...
        channel.send({content: msg, embeds: [embed], components: [Buttons] }).then(m => { m.pin() })
        ...
        //     }, 1 * 1000)
        // })
        interaction.reply({ content: `${member} tu ticket ha sido creado: ${channel}`, ephemeral: true })
