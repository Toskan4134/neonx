                ...
                async (err, docs) => {
                    ...
                    docs.forEach(async (r) => {
                        if (now >= r.Expiration) {
                            ...
                            let winMsg = "";
                            let sendMsg = "";
                            let reactions = await msg.reactions
                                .resolve("🎁")
                                .users.fetch();
                            reactions.map((user) => {
                            ...
                            if (users.length == 0) {
                                ...
                                try {
                                    for (
                                        ...
                                        let user =
                                            await guild.members.cache.get(w[0]);
                                        winMsg +=
                                            i +
                                            1 +
                                            "º " +
                            ...
                            let embed = new MessageEmbed()
                                ...
                                .setTimestamp()
                                .setThumbnail(
                                    "https://img.freepik.com/vector-gratis/sorteo-letreros-neon-sobre-fondo-pared-ladrillo_100690-93.jpg?size=600&ext=jpg"
                                )
                                .setImage(r.Image)
                                .setAuthor({
